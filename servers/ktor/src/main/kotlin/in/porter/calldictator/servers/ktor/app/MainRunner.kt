package `in`.porter.calldictator.servers.ktor.app

import `in`.porter.calldictator.servers.ktor.di.HttpComponentFactory
...
private val logger = logger("in.porter.calldictator.servers.ktor.app.MainRunnerKt")

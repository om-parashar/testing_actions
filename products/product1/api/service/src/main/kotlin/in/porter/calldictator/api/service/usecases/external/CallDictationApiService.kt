...
import `in`.porter.calldictator.api.service.usecases.internal.ProcessRequest
...
@Inject
constructor(
  private val processRequest: ProcessRequest,
  ...
  suspend fun invoke(request: CallDictateRequest): CallDictationResponse {
    ...
    val callerContext = processRequest.invoke(request)
